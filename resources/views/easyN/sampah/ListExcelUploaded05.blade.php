{{-- <h2>Basic CRUD Application</h2>
	...
	<div id="toolbar-upload-{{ $unikId}}">
		...
		<a href="javascript:void(0)" class="easyui-linkbutton " iconCls="icon-add" plain="true" onclick="newUpload('{{$url['FormUpload']}}','Form-Upload-Excel-{{ $unikId}}')" data-link="http://192.168.1.132/bidang/form-upload" data-title="Form-Upload-Excel">Upload File </a>

		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick=" EditExcel{{ $unikId}}('{{$url['FileImport']}}','Excel Editor')">Lihat File</a>
	...
	// }
		...
		// }
		function EditExcel{{ $unikId}}(url,title){
			$(this).attr('disabled', 'disabled');
		console.log(url);
