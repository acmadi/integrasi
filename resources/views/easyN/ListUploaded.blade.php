{{-- <h2>Basic CRUD Application</h2>
	...
	<table id="ListData" title="Daftar File Terupload" class="easyui-datagrid" fit='true'
			url="{{ route('bidang.d.u') }}"
			toolbar="#toolbar-upload" pagination="true"
	...
	<div id="toolbar-upload">

		<a href="javascript:void(0)" class="easyui-linkbutton " iconCls="icon-add" plain="true" onclick="newUpload('http://192.168.1.132/bidang/form-upload','Form-Upload-Excel' )" data-link="http://192.168.1.132/bidang/form-upload" data-title="Form-Upload-Excel">Upload File Lain</a>
		...
		function deleteFile(){
			...
			if (row){
				$.messager.confirm('Confirm','Are you sure you want to destroy this user?',function(r){
					if (r){
						$.post('{{ $df }}',{filename:row.filename,id:row.id},function(result){
