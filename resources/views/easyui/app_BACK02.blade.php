...
<body>
	...
	<div id="kiri" style="float:left;">
		...
		<div class="easyui-accordion" id="menu" style="float:left;width:300px;">

			<div title="Manage DB Bidang"  id="rr" data-options="iconCls:'icon-table'" style="overflow:auto;padding:5px 0px;">
				<div title="TreeMenu" data-options="iconCls:'icon-search'" style="padding:0px;">
					{{-- <ul class="easyui-tree" data-options="url:'{{  route('b.json')}}',method:'get',animaccte:true,dnd:true"></ul> --}}

					<ul class="easyui-tree">
						<li data-options="iconCls:'icon-surat_perintah'">
							<a id="op" onclick="open('fdjksahkfha')">Rekening</a>
						</li>
