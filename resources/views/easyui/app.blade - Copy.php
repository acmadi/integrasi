...
<body onLoad="goforit()">
	...
	<div id="kiri" style="float:left;">
		...
		<div class="easyui-accordion" style="float:left;width:170px;">
			...
			<div title="Manage DB Bidang" data-options="iconCls:'icon-tip'" style="overflow:auto;padding:5px 0px;">
			...
			<div title="Manage DB DPA" data-options="iconCls:'icon-print'" style="overflow:auto;padding:5px 0px;">
				<div title="TreeMenu" data-options="iconCls:'icon-search'" style="padding:0px;">
			...
			<div title="Manage DB Kegiatan" data-options="iconCls:'icon-print'" style="overflow:auto;padding:5px 0px;">
				<div title="TreeMenu" data-options="iconCls:'icon-search'" style="padding:0px;">
			...
			<div title="Manage DB OranisasiSPD " data-options="iconCls:'icon-print'" style="overflow:auto;padding:5px 0px;">
				<div title="TreeMenu" data-options="iconCls:'icon-search'" style="padding:0px;">
			...
			<div title="Manage DB Program " data-options="iconCls:'icon-print'" style="overflow:auto;padding:5px 0px;">
				<div title="TreeMenu" data-options="iconCls:'icon-search'" style="padding:0px;">
			...
			<div title="Manage DB Realisasi " data-options="iconCls:'icon-print'" style="overflow:auto;padding:5px 0px;">
				<div title="TreeMenu" data-options="iconCls:'icon-search'" style="padding:0px;">
			...
			<div title="Manage DB SKPD " data-options="iconCls:'icon-print'" style="overflow:auto;padding:5px 0px;">
				<div title="TreeMenu" data-options="iconCls:'icon-search'" style="padding:0px;">
			...
			<div title="Manage DB Urusan " data-options="iconCls:'icon-print'" style="overflow:auto;padding:5px 0px;">
				<div title="TreeMenu" data-options="iconCls:'icon-search'" style="padding:0px;">
