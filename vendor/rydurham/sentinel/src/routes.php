...
Route::group(['namespace' => 'Sentinel\Controllers'], function(){
    ...
    Route::get('profile/edit', ['as' => 'sentinel.profile.edit', 'uses' => 'ProfileController@edit']);
        // Route::get('profile/editPass', ['as' => 'sentinel.editPass.edit', 'uses' => 'ProfileController@editPass']);
    ...
    Route::get('users', ['as' => 'sentinel.users.index', 'uses' => 'UserController@index']);
        // Route::any('users/data', ['as' => 'sentinel.users.data', 'uses' => 'UserController@getUsers']);
    ...
    Route::get('groups', ['as' => 'sentinel.groups.index', 'uses' => 'GroupController@index']);
        // Route::any('groups/data', ['as' => 'sentinel.groups.data', 'uses' => 'GroupController@getGroups']);
        // Route::any('groups/{hash}/edit-permission', ['as' => 'sentinel.groups.editpermission', 'uses' => 'GroupController@EditPermission']);
        // Route::any('groups/{hash}/CUP', ['as' => 'sentinel.groups.CUP', 'uses' => 'GroupController@CreateUpdatePermission']);
