...
Route::group(['namespace' => 'Sentinel\Controllers'], function(){
    ...
    Route::get('users', ['as' => 'sentinel.users.index', 'uses' => 'UserController@index']);
        Route::post('users/DG', ['as' => 'sentinel.users.DG', 'uses' => 'UserController@DataGrid']);
    ...
    Route::get('groups', ['as' => 'sentinel.groups.index', 'uses' => 'GroupController@index']);
        Route::post('groups/DG', ['as' => 'sentinel.groups.DG', 'uses' => 'GroupController@DataGroups']);
        Route::post('groups/LDB', ['as' => 'sentinel.groups.LDB', 'uses' => 'GroupController@ListDB']);
        Route::any('groups/EditAkses', ['as' => 'sentinel.groups.EA', 'uses' => 'GroupController@EditAkses']);
    ...
    // Route::get('akses', ['as' => 'akses.i', 'uses' => 'GroupController@insertakses']);
    Route::post('akses', ['as' => 'akses.i', 'uses' => 'GroupController@insertakses']);
